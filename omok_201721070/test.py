from omok_201721070 import getWinner
...
board = [
    ...
    [W, B, X, X, W, X, X, W, X, W, X, X, X],
    [B, X, B, X, X, W, X, X, X, X, X, X, W],
    [X, B, B, X, X, W, X, B, B, W, X, X, X],
    [B, X, X, X, X, X, X, X, B, B, W, X, X],
    [X, X, B, X, W, X, W, X, X, B, B, X, B],
    [X, X, X, X, W, B, X, X, B, X, X, X, X],
    [X, X, B, X, X, X, B, X, X, W, X, X, X],
    [X, X, X, X, X, X, X, B, X, X, X, W, X],
    [W, B, X, X, X, X, X, X, B, W, W, X, W],
    [B, X, B, X, X, X, W, W, W, B, X, X, X],
    [X, X, X, X, X, X, X, X, W, X, X, X, X],
]
